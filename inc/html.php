...
function buildPostForm($parent, $staff_post = false) {
	...
	$input_submit = '<input type="submit" value="' . __('Send') . '" accesskey="z">';
...
EOF;
  ...
  text-align: center;">[<span onclick="if (this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display != '') { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = ''; this.innerText = '-X-'; this.value = '-'; } else { this.parentNode.parentNode.getElementsByTagName('div')[1].getElementsByTagName('div')[0].style.display = 'none'; this.innerText = '-NEW-'; }" type="button">-NEW-</span>]<br>
</div>
<div class="alt2">

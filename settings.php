...
define('TINYIB_UPDATEBUMPED', false);  // Update thread position when a reply is deleted
...
define('TINYIB_DEFAULTSTYLE', 'yotsuba'); // Default page style
...
$tinyib_hidefields = array('email','subject','password');         // Fields to hide when replying
...
define('TINYIB_MAXWOP', 251);         // Width
define('TINYIB_MAXHOP', 251);         // Height

// Thumbnail size - reply
define('TINYIB_MAXW', 251);           // Width
define('TINYIB_MAXH', 251);           // Height

// Tripcode seed - Must not change once set!
define('TINYIB_TRIPSEED', 'g4kam02vod8kje4uiy');        // Enter some random text  (used when generating secure tripcodes, hashing passwords and hashing IP addresses)
...
define('TINYIB_ADMINPASS', 'a9999');       // Administrator password
define('TINYIB_MODPASS', 'ammmm');         // Moderator password  ['' to disable]
...
define('TINYIB_DBPATH', '.a1.db');  // SQLite DB path
